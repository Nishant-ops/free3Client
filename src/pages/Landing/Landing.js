    ...
    <body className="landing-page__wrapper">
      ...
      <section class="info">
        <div class="contenedor">
          <h2 class="title left">
            Ismail OUKHA & Anas LAMAIIZ,{" "}
            <b style={{ color: "black" }}>Developers</b>
          </h2>
          <br></br>
          <br></br>
          <p>
            “FreelanceConnect is an innovative and dynamic online platform
            designed to revolutionize the world of freelancing.<br></br> It
            serves as a centralized hub, connecting talented freelancers with
            businesses and individuals seeking their expertise.”
          </p>
        </div>
      </section>
      <section className="cards contenedor" id="reviews">
        ...
        <div className="content-cards">
          <article className="card">
            ...
            <p>
              <q>
                I recently had the pleasure of using FreelanceConnect. This
                website is a great tool for freelancers to find jobs and post
                their own services.
              </q>
            </p>
          </article>
          <article className="card">
            ...
            <p>
              <q>
                The website is also secure and provides a secure payment system.
                Payment is done through the website and is secure and reliable.
              </q>
            </p>
          </article>
          <article className="card">
            ...
            <p>
              <q>
                Overall, I highly recommend FreelanceConnect for freelancers
                looking for jobs or services. The website is reliable, secure,
                and user-friendly.
              </q>
            </p>
          </article>

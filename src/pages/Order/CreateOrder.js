...
function CreateOrder(props) {
  ...
  return (
    <div className="create-order__container col-xs-12 col-sm-12 col-md-8 col-lg-6">
      <h1>New Order</h1>
      {serviceData && <ServiceCardHorizontal service={serviceData.service} />}
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="input__container">
          ...
          {formik.touched.order_deadline && formik.errors.order_deadline ? (
            <p className="info__validation email__validation">
              {formik.errors.order_deadline}
            </p>
          ) : null}
        </div>
        {orderLoading ? (
          <button className="create-service__submit-button" type="submit">
            Loading...
          </button>
        ) : (
          <button className="create-service__submit-button" type="submit">
